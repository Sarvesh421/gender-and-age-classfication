...
# Open a video capture object, either from a file or webcam
video = cv2.VideoCapture(args.image if args.image else 0)
padding = 20

while cv2.waitKey(1) < 0:
    hasFrame, frame = video.read(r'C:\Users\sarve\OneDrive\Documents\python\python\video.mp4')
    if not hasFrame:
        cv2.waitKey()
        break
    ...
    # Gender and age prediction for each detected face
